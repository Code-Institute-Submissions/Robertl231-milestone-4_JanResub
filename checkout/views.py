...
def cache_checkout_data(request):
    try:
        ...
        messages.error(request, 'Your payment cannot be processed at the minute. We apologies for any inconvienience.')
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            messages.error(request, 'There was an error with your form, make sure you filled it out correctly.')
    else:
        bag = request.session.get('bag', {})
        if not bag:
...
def checkout_success(request, order_number):
    ...
    if request.user.is_authenticated:
        ...
        if save_info:
            ...
            user_profiles_form = UserProfileForm(profile_data, instance=profile)
